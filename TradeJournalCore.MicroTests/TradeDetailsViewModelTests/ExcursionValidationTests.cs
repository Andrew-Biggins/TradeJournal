...
namespace TradeJournalCore.MicroTests.TradeDetailsViewModelTests
{
    public sealed class ExcursionValidationTests
    {
        ...
        //    // Act 
        //    var actual = viewModel.IsHighFixed;
        ...
        //    // Assert
        //    viewModel.High.IfExistsThen(x => { actual = x; });
        ...
        public void T3()
        {
            ...
            // Assert
            Assert.False(viewModel.IsHighFixed);
        }
        ...
        //    // Act 
        //    viewModel.Low = Option.Some(5.0);

        //    // Assert
        //    Assert.True(viewModel.TradeDetailsValidator.LowHasError);
        //}
    }
}
